    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body ">
            <p class="card-description text-center">{{ __('Enjoy your study!') }}</p>
            <div class="bmd-form-group{{ $errors->has('fname') ? ' has-danger' : '' }}">
              ...
              @if ($errors->has('fname'))
                <div id="fname-error" class="error text-danger pl-3" for="name" style="display: block;">
            ...
            <div class="bmd-form-group{{ $errors->has('lname') ? ' has-danger' : '' }}">
              ...
              @if ($errors->has('lname'))
                <div id="lname-error" class="error text-danger pl-3" for="name" style="display: block;">
